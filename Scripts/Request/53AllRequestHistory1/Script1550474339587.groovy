...
a = WS.sendRequest(findTestObject('Request/53AllRequestHistory'))
...
WS.verifyElementPropertyValue(a, 'ObjReturn[4].RequestHistoryId', 5)

WS.verifyElementPropertyValue(a, 'ObjReturn[4].RequestId', 3)

WS.verifyElementPropertyValue(a, 'ObjReturn[4].PreSupporter_Name', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[4].PreStatus', 3)

WS.verifyElementPropertyValue(a, 'ObjReturn[4].CreateDate', '11:22 17/01/2019')

WS.verifyElementPropertyValue(a, 'ObjReturn[4].StartDate', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[4].EndDate', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[5].RequestHistoryId', 6)

WS.verifyElementPropertyValue(a, 'ObjReturn[5].RequestId', 1)

WS.verifyElementPropertyValue(a, 'ObjReturn[5].PreSupporter_Name', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[5].PreStatus', 1)

WS.verifyElementPropertyValue(a, 'ObjReturn[5].CreateDate', '15:38 17/01/2019')

WS.verifyElementPropertyValue(a, 'ObjReturn[5].StartDate', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[5].EndDate', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[6].RequestHistoryId', 7)

WS.verifyElementPropertyValue(a, 'ObjReturn[6].RequestId', 1)

WS.verifyElementPropertyValue(a, 'ObjReturn[6].PreSupporter_Name', 'Phạm Phú Tiến')

WS.verifyElementPropertyValue(a, 'ObjReturn[6].PreStatus', 3)

WS.verifyElementPropertyValue(a, 'ObjReturn[6].CreateDate', '15:39 17/01/2019')

WS.verifyElementPropertyValue(a, 'ObjReturn[6].StartDate', '01/17/2019')

WS.verifyElementPropertyValue(a, 'ObjReturn[6].EndDate', '01/17/2019')

WS.verifyElementPropertyValue(a, 'ObjReturn[7].RequestHistoryId', 8)

WS.verifyElementPropertyValue(a, 'ObjReturn[7].RequestId', 17)

WS.verifyElementPropertyValue(a, 'ObjReturn[7].PreSupporter_Name', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[7].PreStatus', 5)

WS.verifyElementPropertyValue(a, 'ObjReturn[7].CreateDate', '11:15 19/01/2019')

WS.verifyElementPropertyValue(a, 'ObjReturn[7].StartDate', null)

WS.verifyElementPropertyValue(a, 'ObjReturn[7].EndDate', null)*/